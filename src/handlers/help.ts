...
const HELP =
  "Use Register team to submit your captain contact and player details.\n\n" +
  "View teams & table shows active teams and match results. Tournament controls are available to the owner.";
